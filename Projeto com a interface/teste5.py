#Este teste me entregou as fotos de perfil dos usuarios e também está enumerando os projetos
...
# Funções de busca
def buscar_perfis_github(nome, sobrenome, localizacao, pagina=1):
...
def consultar():
    ...
    perfis = buscar_perfis_github(nome_pessoa, sobrenome_pessoa, localizacao_pessoa, pagina=pagina_atual)
