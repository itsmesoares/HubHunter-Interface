...
import webbrowser  # Abertura de URLs no navegador
from tkinter import messagebox  
import math  # Operações matemáticas
import tkinter as tk  # Criação de interfaces gráficas
from io import BytesIO  # Manipulação de fluxos de dados em memória
import urllib.parse  # Manipulação de URLs

# Variáveis globais
ultimos_perfis = []  # Armazena os últimos perfis buscados
total_paginas = 0  # Total de páginas de resultados
pagina_atual = 1  # Página atual na busca de perfis
...
def buscar_perfis_github(nome, sobrenome, estado, cidade, pagina=1):
    resultados_por_pagina = 10  # Define quantos resultados por página
    query = f'{nome}+{sobrenome}+location:"{cidade}+{estado}"'  # Cria a query de busca
